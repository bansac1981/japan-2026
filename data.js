...
// Family: Achin, Snigdha, Anagha (child), Sharanya (child) ÃÂÃÂÃÂÃ· Pure Vegetarian
...
const TRIP_DATA = {
  ...
  days: [
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 1 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ARRIVAL TOKYO ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        ...
        { name: "Immigration + Arrivals", time: "05:35ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ07:00", cost: "Free",
          notes: "Fill immigration card on plane. Biometric fingerprint scan at entry. Pick up pre-ordered pocket WiFi / SIM at arrivals hall (HND T2 has collection counters open from 6am). Change ÃÂÃÂÃÂÃ¥20,000 at airport for first 2 days.",
          location: "Haneda Airport Terminal 2 Tokyo", ticket: "Not yet needed" },
        { name: "Buy Suica IC Cards + Store Bags", time: "07:00ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ07:30", cost: "ÃÂÃÂÃÂÃ¥2,000 deposit each",
          notes: "Buy at HND station ticket machine ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tap 'ÃÂÃÂ¨ÃÂÃÂÃÂÃÂ±ÃÂÃÂ¨ÃÂÃÂªÃÂÃÂ' (English). Load ÃÂÃÂÃÂÃ¥3,000 per card. These cards pay for all trains, buses, and convenience stores. Store bags in HND coin lockers (ÃÂÃÂÃÂÃ¥400ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ600) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ check-in isn't until 17:00.",
          location: "Haneda Airport Station Tokyo", ticket: "Just buying the Suica now" },
        { name: "Relax at HND or Nearby CafÃÂÃÂÃÂÃÂ©", time: "07:30ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ16:00", cost: "~ÃÂÃÂÃÂÃ¥2,000",
          ...
          location: "Haneda Airport Terminal 2 Tokyo", ticket: "Suica IC Card ÃÂÃÂÃÂÃ· Keikyu Line ÃÂÃÂÃÂÃ¥310" },
        { name: "Route to AO103 Apt, Aoto", time: "16:00", cost: "~ÃÂÃÂÃÂÃ¥700/person",
          notes: "Keikyu Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Shinagawa (ÃÂÃÂÃÂÃ¥410) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ JR Yamanote ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Nippori ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Keisei Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Aoto (~65 min). OR taxi ÃÂÃÂÃÂÃ¥5,000ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ6,000 for heavy luggage. Ask driver 'Aoto station, please' (ÃÂÃÂ£ÃÂÃÂÃÂÃÂ¢ÃÂÃÂ£ÃÂÃÂÃÂÃÂªÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ©ÃÂÃÂ§ÃÂÃÂ).",
          location: "Aoto Station Katsushika Tokyo", ticket: "Suica IC Card ÃÂÃÂÃÂÃ· Keikyu + JR Yamanote + Keisei" },
      ...
      food: [
        { name: "Onigiri (rice balls)", where: "Any 7-Eleven / FamilyMart", price: "ÃÂÃÂÃÂÃ¥120ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ180", notes: "Tuna-free options: umeboshi (plum), konbu (seaweed), cheese. Look for ÃÂÃÂ¦ÃÂÃÂ¢ÃÂÃÂ or ÃÂÃÂ¦ÃÂÃÂÃÂÃÂÃÂÃ¥ÃÂÃÂ¸ÃÂÃÂ." },
        { name: "Vegetable Curry", where: "Airport food court", price: "~ÃÂÃÂÃÂÃ¥900", notes: "Japanese curry is mild and usually has a vegetarian option. Ask: ÃÂÃÂ¨ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂªÃÂÃÂ£ÃÂÃÂÃÂÃÂ (niku nashi = no meat)." }
      ],
      shopping: [
        { name: "Suica Card + SIM", where: "Haneda Airport Station / arrivals", price: "ÃÂÃÂÃÂÃ¥2,000 deposit", notes: "Most important purchase of the trip ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ covers almost all transport and konbini shopping." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 2 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ASAKUSA + YANAKA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        { name: "Senso-ji Temple, Asakusa", time: "08:00", cost: "Free",
          notes: "Tokyo's oldest temple (628 AD). Giant red Kaminarimon lantern gate. Nakamise shopping street opens 10am ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ningyo-yaki (fish-shaped cake filled with bean paste) ÃÂÃÂÃÂÃ¥150. Beautiful incense burner: waft smoke over the kids for good luck!",
          location: "Sensoji Temple Asakusa Tokyo", ticket: "Suica ÃÂÃÂÃÂÃ· Keisei Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Aoto ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Asakusa (~25 min, ÃÂÃÂÃÂÃ¥240)" },
        { name: "Nakamise Shopping Street", time: "10:00", cost: "~ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,000 snacks",
          notes: "250m arcade of traditional stalls. Get: ningyo-yaki ÃÂÃÂÃÂÃ¥150, agemunji (fried dough with sesame) ÃÂÃÂÃÂÃ¥200, kaminari-okoshi (rice cracker) ÃÂÃÂÃÂÃ¥300. All vegetarian! Don't buy 'ninja swords' ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ kids will fence each other all trip.",
          location: "Nakamise Shopping Street Asakusa Tokyo", ticket: "Walk from Senso-ji" },
        { name: "Yanaka Ginza Old Town", time: "12:00", cost: "Free",
          notes: "Tokyo's last pre-war neighbourhood. Shotengai with resident cats, pottery studios, old-fashioned candy shops. Melon-pan ÃÂÃÂÃÂÃ¥200. Walk: 10 min from Nippori station. The cemetery is actually lovely ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ peaceful stroll under old trees.",
          location: "Yanaka Ginza Tokyo", ticket: "Suica ÃÂÃÂÃÂÃ· Walk from Nippori (Keisei Line, ÃÂÃÂÃÂÃ¥150)" },
        { name: "Ueno Park + Shinobazu Pond", time: "14:30", cost: "Free",
          notes: "Lotus-covered pond, swan boats ÃÂÃÂÃÂÃ¥700/30 min. Tokyo National Museum (kids: mummy room!) ÃÂÃÂÃÂÃ¥630 adult. Ameyoko street market for cheap snacks and goods.",
          location: "Ueno Park Tokyo", ticket: "Walk 7 min from Yanaka" }
      ],
      food: [
        { name: "Ningyo-yaki", where: "Nakamise Street, Asakusa", price: "ÃÂÃÂÃÂÃ¥150 each", notes: "Bean-paste filled rice cakes shaped like Kaminarimon lanterns. Freshly made, warm ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ kids love them." },
        { name: "Melon Pan", where: "Yanaka Ginza stalls", price: "ÃÂÃÂÃÂÃ¥200", notes: "Sweet bread with a crispy sugar crust. Best eaten warm. Classic Tokyo snack." },
        { name: "Vegetable ramen", where: "Soranoiro near Asakusa", price: "~ÃÂÃÂÃÂÃ¥1,200", notes: "One of Tokyo's few dedicated veg ramen spots. Try the tomato veg ramen." }
      ],
      shopping: [
        { name: "Traditional crafts / tenugui", where: "Nakamise / Yanaka shops", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,000", notes: "Tenugui (thin Japanese towel/cloth) make great gifts and are lightweight." },
        { name: "Agemunji rice crackers", where: "Nakamise Asakusa", price: "ÃÂÃÂÃÂÃ¥300", notes: "Traditional Tokyo sweet ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ bring some back for Pune!" }
      ],
      ...
      hacks: ["ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Visit Senso-ji before 8am ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ completely empty, zero charge. Temple is open 24/7.", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Let kids pull an omikuji (fortune paper) from the box at Senso-ji ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃ¥100 and absolutely thrilling.","ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Ueno Park is free and has multiple museums ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ pick one if it rains."]
    },
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 3 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DISNEYLAND ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      startLocation: "Aoto Station Katsushika Tokyo",
      activities: [
        { name: "Tokyo Disneyland ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Full Day", time: "08:00ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ21:00", cost: "ÃÂÃÂÃÂÃ¥9,400 adult / ÃÂÃÂÃÂÃ¥5,800 child (4ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ11)",
          notes: "Fantasyland (kids!): Peter Pan's Flight, Dumbo, Pooh, Carousel. Tomorrowland: Space Mountain, Buzz Lightyear. Big Thunder Mountain (kids' favourite!). Haunted Mansion ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Achin & Snigdha ride while kids watch. Electrical Parade at dusk ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ perfect evening ending. 31 Ice Cream ÃÂÃÂÃÂÃ¥31 scoops on your birthday number! Vegetarian: fries, corn, fruit cups, popcorn carts everywhere.",
          location: "Tokyo Disneyland Urayasu Chiba", officialUrl: "https://www.tokyodisneyresort.jp/en/tdl.html",
          ticket: "Suica + JR Keiyo Line ÃÂÃÂÃÂÃ· Nippori ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Maihama (25 min, ÃÂÃÂÃÂÃ¥420) OR direct bus from near apt" }
      ],
      food: [
        { name: "Popcorn (seasonal flavours!)", where: "Popcorn carts around park", price: "ÃÂÃÂÃÂÃ¥400ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ500", notes: "Caramel, curry, milk tea flavours. Vegetarian and amazing! Get a bucket." },
        { name: "Gyoza Man (veg version)", where: "Fantasyland counter", price: "ÃÂÃÂÃÂÃ¥600", notes: "Ask specifically for vegetable version at the Fantasyland counter near Cinderella Castle." },
        { name: "Soft serve ice cream", where: "Various carts", price: "ÃÂÃÂÃÂÃ¥300ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ500", notes: "Seasonal flavours ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ May often has melon or strawberry." }
      ],
      shopping: [
        { name: "Disney character goods", where: "World Bazaar entrance", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3,000", notes: "Buy on the WAY OUT at World Bazaar (entrance area) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ same selection, you'll have carried it all day otherwise." },
        { name: "Mickey popcorn bucket", where: "Popcorn carts", price: "ÃÂÃÂÃÂÃ¥2,400", notes: "Reusable bucket with refills ÃÂÃÂÃÂÃ¥400. Worth it for a long day." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 4 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ TEAMLAB + ODAIBA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        {
          ...
          cost: 'ÃÂÃÂÃÂÃ¥2300 per person (online booking recommended for discount)',
        ...
        { name: "teamLab Planets, Toyosu", time: "09:00 (PRE-BOOKED SLOT)", cost: "ÃÂÃÂÃÂÃ¥3,200 adult / ÃÂÃÂÃÂÃ¥800 child (4ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ12)",
          ...
          ticket: "Suica ÃÂÃÂÃÂÃ· Yurakucho Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Toyosu (ÃÂÃÂÃÂÃ¥240)" },
        { name: "Life-size Gundam Statue, Odaiba", time: "12:00", cost: "Free",
          ...
          location: "DiverCity Tokyo Plaza Odaiba", ticket: "Suica ÃÂÃÂÃÂÃ· Yurikamome Line from Shimbashi ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Odaiba-kaihin-koen (ÃÂÃÂÃÂÃ¥320)" },
        ...
        { name: "Palette Town / Joypolis", time: "16:00", cost: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,000",
      ...
      food: [
        { name: "Veggie sushi set", where: "Conveyor belt sushi near Toyosu market", price: "ÃÂÃÂÃÂÃ¥800ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,200", notes: "Kappa (cucumber), avocado, pickled plum rolls are all vegetarian. Say 'vegetarian' (ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ¸ÃÂÃÂ£ÃÂÃÂÃÂÃÂ¿ÃÂÃÂ£ÃÂÃÂÃÂÃÂªÃÂÃÂ£ÃÂÃÂÃÂÃÂ¢ÃÂÃÂ£ÃÂÃÂÃÂÃÂ³) to staff." },
        { name: "Crepes", where: "Odaiba mall food court", price: "ÃÂÃÂÃÂÃ¥600ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ800", notes: "Strawberry + cream crepes are always vegetarian and a hit with kids." }
      ],
      shopping: [
        { name: "Unique digital art goods", where: "teamLab shop (exit)", price: "ÃÂÃÂÃÂÃ¥1,000ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3,000", notes: "Beautiful art prints, notebooks, scarves in the teamLab aesthetic." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 5 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ MEIJI + HARAJUKU + SHIBUYA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        { name: "Meiji Shrine", time: "08:00", cost: "Free",
          notes: "Sacred forested path through 100,000 trees ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ astonishing quiet in the middle of 14m-person Tokyo. Arrive before 8am. Writing a wish on an ema (wooden plaque) is ÃÂÃÂÃÂÃ¥600 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ kids love it. The sake barrel display near the entrance is iconic.",
          location: "Meiji Jingu Shrine Harajuku Tokyo", officialUrl: "https://www.meijijingu.or.jp/en/",
          ticket: "Suica ÃÂÃÂÃÂÃ· JR Yamanote ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Harajuku Stn (ÃÂÃÂÃÂÃ¥200 from Nippori)" },
        { name: "Harajuku Takeshita Street", time: "10:30", cost: "Free to browse",
          notes: "Tokyo's most bonkers fashion street. Crepes ÃÂÃÂÃÂÃ¥400ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ600 (strawberry cream is always vegetarian). Rainbow cotton candy ÃÂÃÂÃÂÃ¥600. Pastel colour everything. Kids will want everything ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ set a budget before entering!",
        ...
        { name: "Shibuya Scramble Crossing", time: "14:00", cost: "Free",
          ...
          location: "Shibuya Scramble Crossing Tokyo", ticket: "Suica ÃÂÃÂÃÂÃ· JR Yamanote ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Shibuya (ÃÂÃÂÃÂÃ¥160)" },
        { name: "Shibuya Sky Observatory", time: "17:30 (sunset!)", cost: "ÃÂÃÂÃÂÃ¥2,000 adult / ÃÂÃÂÃÂÃ¥1,200 child",
      ...
      food: [
        { name: "Harajuku crepes", where: "Any crepe stand on Takeshita St", price: "ÃÂÃÂÃÂÃ¥400ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ600", notes: "Strawberry + cream, matcha + red bean, banana + Nutella. All have veg options." },
        { name: "Komeda Coffee breakfast", where: "Near Harajuku station", price: "~ÃÂÃÂÃÂÃ¥700", notes: "Free thick toast with any morning drink before 11am. Real filling breakfast hack." },
        { name: "Shibuya food basement (depachika)", where: "Shibuya Hikarie B2F", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500", notes: "Incredible prepared foods. Get onigiri sets, veggie bento, matcha sweets before the observatory." }
      ],
      shopping: [
        { name: "PokÃÂÃÂÃÂÃÂ©mon merchandise", where: "PokÃÂÃÂÃÂÃÂ©mon Center Shibuya (free entry)", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5,000", notes: "Three floors of PokÃÂÃÂÃÂÃÂ©mon everything. Kids will go berserk ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ set a budget and browse freely." },
        { name: "Pastel fashion items", where: "Takeshita Street boutiques", price: "ÃÂÃÂÃÂÃ¥1,000ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3,000", notes: "Headbands, accessories, quirky socks ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ inexpensive and very Tokyo." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 6 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ AKIHABARA + RENKOJI ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        ...
        { name: "Akihabara Electric Town", time: "10:00", cost: "Free to browse",
          notes: "Tokyo's legendary electronics and anime district. Multi-floor retro game stores, anime figurine shops, manga cafÃÂÃÂÃÂÃÂ©s. PokÃÂÃÂÃÂÃÂ©mon Center DX (7th floor, Yodobashi AKB): free entry, largest in Japan. Radio Kaikan building has 9 floors of collectibles. Gacha machines on every corner ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃ¥200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ500 per try.",
          location: "Akihabara Electric Town Tokyo", ticket: "Suica ÃÂÃÂÃÂÃ· JR Yamanote ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Akihabara (ÃÂÃÂÃÂÃ¥200 from Aoto via Nippori)" },
        ...
        { name: "Renkoji Temple (Netaji Bose Memorial)", time: "15:00", cost: "Free",
          ...
          location: "Renkoji Temple Koenji Tokyo", ticket: "Suica ÃÂÃÂÃÂÃ· Tokyo Metro Marunouchi Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Higashi-Koenji (ÃÂÃÂÃÂÃ¥200)" },
        { name: "Indian Dinner at AO103 Apt Kitchen", time: "Evening", cost: "ÃÂÃÂÃÂÃ¥1,500 groceries",
          ...
          location: "Aoto Station Katsushika Tokyo", ticket: "Suica ÃÂÃÂÃÂÃ· Return to Aoto" }
      ],
      food: [
        { name: "Maid cafÃÂÃÂÃÂÃÂ© experience", where: "@home cafÃÂÃÂÃÂÃÂ©, Akihabara", price: "ÃÂÃÂÃÂÃ¥1,500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,000 cover", notes: "Unique Tokyo experience ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ costumed maids draw on your omurice (omelette rice). Vegetarian option available." },
        { name: "Don Quijote instant food", where: "Don Quijote Akihabara", price: "ÃÂÃÂÃÂÃ¥200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ400", notes: "Japanese instant noodles, rice crackers, exotic Kit Kats for kids ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ cheap and fun haul." }
      ],
      shopping: [
        { name: "Gacha machine capsule toys", where: "Akihabara (everywhere!)", price: "ÃÂÃÂÃÂÃ¥200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ500 per try", notes: "Budget ÃÂÃÂÃÂÃ¥1,500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,000 per child. PokÃÂÃÂÃÂÃÂ©mon, Sanrio, Studio Ghibli gacha available." },
        { name: "Souvenir snacks", where: "Don Quijote", price: "ÃÂÃÂÃÂÃ¥200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ500/pack", notes: "Pocky, Tokyo Banana, Royce chocolate, Matcha Kit Kat ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ good value vs airport." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 7 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ NIKKO ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        { name: "Tobu Line: Asakusa ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Nikko", time: "Depart 07:30", cost: "Tobu 2-day pass ÃÂÃÂÃÂÃ¥2,720 adult / ÃÂÃÂÃÂÃ¥1,360 child",
        ...
        { name: "Toshogu Shrine (UNESCO)", time: "09:30", cost: "ÃÂÃÂÃÂÃ¥1,300 adult / ÃÂÃÂÃÂÃ¥450 child",
        ...
        { name: "Shinkyo Sacred Bridge", time: "11:30", cost: "Free to view / ÃÂÃÂÃÂÃ¥300 to cross",
        ...
        { name: "Kegon Falls", time: "12:30", cost: "ÃÂÃÂÃÂÃ¥570 elevator to base",
        ...
        { name: "Lake Chuzenji", time: "14:00", cost: "Free / Boat ÃÂÃÂÃÂÃ¥1,000",
          notes: "Stunning mountain lake at 1,269m altitude. Boat rides available. Walk along the shore for calm mountain views. Try black-sesame soft serve at the lake stalls ÃÂÃÂÃÂÃ¥350.",
      ...
      food: [
        { name: "Yuba (tofu skin) cuisine", where: "Nikko restaurants near shrine", price: "ÃÂÃÂÃÂÃ¥1,200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,800 set", notes: "Nikko is famous for yuba (tofu skin). Veg tofu skin tempura set is delicious and easy to find." },
        { name: "Black sesame soft serve", where: "Lake Chuzenji stalls", price: "ÃÂÃÂÃÂÃ¥350", notes: "Rich, nutty flavour. Also try the frozen lemon from stalls near the shrine." }
      ],
      shopping: [
        { name: "Nikko's miso and pickled veg", where: "Souvenir shops near Toshogu", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500", notes: "Great quality regional miso paste and pickled mountain vegetables. Lightweight to carry." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 8 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ TRANSIT: TOKYO ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ HAKONE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ KYOTO ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        { name: "Check out AO103 Apt (10:00)", time: "10:00", cost: "",
          notes: "Leave apartment clean, return key per booking instructions. Leave bags at Shinjuku Station coin lockers (ÃÂÃÂÃÂÃ¥500) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ easier to access for Romancecar.",
          location: "Shinjuku Station Tokyo", ticket: "Suica ÃÂÃÂÃÂÃ· Keisei ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Nippori ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ JR Yamanote ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Shinjuku" },
        { name: "Odakyu Romancecar: Shinjuku ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Hakone-Yumoto", time: "~11:00", cost: "Hakone Free Pass ÃÂÃÂÃÂÃ¥7,100 adult / ÃÂÃÂÃÂÃ¥3,550 child + ÃÂÃÂÃÂÃ¥1,200 Romancecar surcharge",
          notes: "Scenic, comfortable express train with panoramic windows. Buy Hakone Free Pass at Shinjuku Odakyu counter (covers all transport in Hakone). Romancecar surcharge ÃÂÃÂÃÂÃ¥1,200 adult ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ book window seats!",
        ...
        { name: "Hakone Ropeway over Owakudani", time: "13:00", cost: "Included in Free Pass",
          notes: "Float over active volcanic vents! Sulphur steam rising below. Buy kuro-tamago (black volcanic eggs, hardboiled in the vents) ÃÂÃÂÃÂÃ¥600/5 eggs. Said to add 7 years to your life per egg. Kids love it!",
      ...
      food: [
        { name: "Kuro-tamago (black volcanic eggs)", where: "Owakudani ropeway stop", price: "ÃÂÃÂÃÂÃ¥600/5 eggs", notes: "Hardboiled in volcanic sulphur springs. Jet black shell, normal inside. Each adds 7 years to life according to legend!" },
        { name: "Ekiben (train bento)", where: "Odawara or Shinkansen platform shops", price: "ÃÂÃÂÃÂÃ¥1,200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500", notes: "Traditional train bento box. Veg options usually include tofu, pickles, rice, vegetable tempura sets." }
      ],
      shopping: [],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 9 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ARASHIYAMA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        {
          ...
          cost: 'ÃÂÃ¥3,300 (adults), ÃÂÃ¥2,200 (youth), ÃÂÃ¥1,100 (children)',
        ...
        { name: "Arashiyama Bamboo Grove (EARLY!)", time: "06:00", cost: "FREE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Always open",
          ...
          location: "Arashiyama Bamboo Grove Sagano Kyoto", ticket: "Suica ÃÂÃÂÃÂÃ· JR Sagano Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Saga-Arashiyama Stn (ÃÂÃÂÃÂÃ¥240 from Kyoto Stn)" },
        { name: "Tenryu-ji Zen Garden (UNESCO)", time: "08:30", cost: "ÃÂÃÂÃÂÃ¥500/person",
          notes: "700-year-old Zen garden with Mt. Arashiyama as its 'borrowed scenery'. The pond reflects the mountain ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ deeply peaceful. Shigetsu restaurant inside serves shojin ryori (Buddhist veg cuisine) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ book in advance for lunch ÃÂÃÂÃÂÃ¥5,000.",
          location: "Tenryuji Temple Arashiyama Kyoto", officialUrl: "https://www.tenryuji.com/en/",
          ticket: "3-min walk from Bamboo Grove" },
        { name: "Monkey Park Iwatayama", time: "10:00", cost: "ÃÂÃÂÃÂÃ¥550 adult / ÃÂÃÂÃÂÃ¥250 child",
          notes: "Steep 15-min hike up (go slow with kids). At top: 170 free-roaming Japanese macaques! You can hand-feed them through a mesh window with apple slices ÃÂÃÂÃÂÃ¥100. The monkeys will stare you down. Incredible panoramic view of Kyoto.",
          location: "Iwatayama Monkey Park Arashiyama Kyoto", officialUrl: "https://www.monkeypark.jp/",
          ticket: "Walk 5 min from Tenryu-ji" },
        { name: "Togetsukyo Bridge + Bike Ride", time: "12:30", cost: "ÃÂÃÂÃÂÃ¥1,000/bike rental",
        ...
        { name: "Shojin Ryori Lunch (Buddhist Veg)", time: "13:00", cost: "ÃÂÃÂÃÂÃ¥1,500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,500 set",
      ...
      food: [
        { name: "Shojin Ryori (Buddhist cuisine)", where: "Shigetsu at Tenryu-ji or area restaurants", price: "ÃÂÃÂÃÂÃ¥1,500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5,000", notes: "Pure Buddhist vegetarian ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ absolutely no meat, no fish, no eggs. Elegant presentation. Kids enjoy the tofu." },
        { name: "Yuba (tofu skin) soft serve", where: "Stalls near bamboo grove", price: "ÃÂÃÂÃÂÃ¥350", notes: "Unique Kyoto flavour. Rich, creamy. Also try matcha soft serve everywhere here." },
        { name: "Warabi mochi", where: "Wagashi shops near Togetsukyo", price: "ÃÂÃÂÃÂÃ¥400ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ600", notes: "Jelly-like rice cake dusted in kinako (roasted soy powder) and sugar. 100% vegetarian traditional sweet." }
      ],
      shopping: [
        { name: "Kyoto ceramics & pottery", where: "Arashiyama souvenir shops", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3,000", notes: "Handmade cups, small plates in traditional Kyoto patterns. Lighter than you think ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ good gifts." },
        { name: "Bamboo crafts", where: "Shops near Bamboo Grove", price: "ÃÂÃÂÃÂÃ¥300ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500", notes: "Bamboo chopstick sets, small baskets, kids' bamboo toys ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ unique to this area." }
      ],
      ...
      hacks: ["ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Bamboo Grove is FREE and open 24/7 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ arrive at 6am for magical emptiness.", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Monkey Park: feed monkeys through the mesh window with apple slices ÃÂÃÂÃÂÃ¥100 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ kids absolutely love it.", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Bike rental: ÃÂÃÂÃÂÃ¥1,000 for the whole afternoon and covers more ground than walking."]
    },
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 10 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FUSHIMI INARI + KINKAKUJI CIRCUIT ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        { name: "Fushimi Inari Taisha (EARLY!)", time: "06:00", cost: "FREE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Open 24/7",
          notes: "Thousands of vermilion torii gates winding 4km up the mountain. Open 24/7, completely free. Hike to Yotsutsuji intersection (1 hr) for the panoramic city view ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ perfect for kids. The foxes (kitsune statues) are Inari's messengers. Don't miss the small stalls selling inari sushi ÃÂÃÂÃÂÃ¥200.",
          location: "Fushimi Inari Taisha Kyoto", officialUrl: "https://inari.jp/en/",
          ticket: "Suica ÃÂÃÂÃÂÃ· JR Nara Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Inari Stn (5 min, ÃÂÃÂÃÂÃ¥150 from Kyoto Stn)" },
        { name: "Kiyomizudera Temple", time: "09:30", cost: "ÃÂÃÂÃÂÃ¥500 adult / ÃÂÃÂÃÂÃ¥200 child",
          notes: "Hillside temple with a massive wooden stage jutting over the valley ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ no nails used! Stunning views. The approach (Ninenzaka & Sannenzaka lanes) is lined with matcha shops, pottery stores, traditional sweets. Budget ÃÂÃÂÃÂÃ¥500 for snacks on the way up.",
          location: "Kiyomizudera Temple Higashiyama Kyoto",
          ticket: "Suica ÃÂÃÂÃÂÃ· Bus #100 from Kyoto Stn ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Gojo-zaka (ÃÂÃÂÃÂÃ¥230)" },
        { name: "Ninenzaka & Sannenzaka Historic Lanes", time: "11:00", cost: "Free",
          notes: "Cobblestone lanes with preserved Edo-period townhouses. Best photo streets in Kyoto! Matcha soft serve ÃÂÃÂÃÂÃ¥300. Yatsuhashi (cinnamon mochi) shop every 5 steps. Kids love the old street feel.",
          location: "Ninenzaka Sannenzaka Higashiyama Kyoto", ticket: "Walk from Kiyomizudera" },
        { name: "Kinkakuji ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Golden Pavilion", time: "14:00", cost: "ÃÂÃÂÃÂÃ¥500 adult / ÃÂÃÂÃÂÃ¥300 child",
          ...
          ticket: "Suica ÃÂÃÂÃÂÃ· Bus #205 or #101 from Gion ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Kinkakuji-michi (ÃÂÃÂÃÂÃ¥230)" },
        { name: "Ryoanji Rock Garden", time: "15:30", cost: "ÃÂÃÂÃÂÃ¥600 adult / ÃÂÃÂÃÂÃ¥300 child",
      ...
      food: [
        { name: "Inari sushi (kitsune sushi)", where: "Stalls at Fushimi Inari entrance", price: "ÃÂÃÂÃÂÃ¥200/3 pieces", notes: "Sweet fried tofu pouches filled with rice ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ a Kyoto specialty named after Inari foxes. 100% vegetarian!" },
        { name: "Matcha soft serve", where: "Every shop on Ninenzaka/Sannenzaka", price: "ÃÂÃÂÃÂÃ¥300", notes: "Rich, bitter-sweet matcha ice cream. Kyoto matcha is the best in Japan. Get the double cone ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ matcha + hojicha." },
        { name: "Yatsuhashi", where: "Nishio Yatsuhashi on Ninenzaka", price: "ÃÂÃÂÃÂÃ¥400ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ800 per box", notes: "Kyoto's most famous sweet ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ raw mochi in cinnamon or matcha flavour, folded around bean paste. Totally vegetarian." }
      ],
      shopping: [
        { name: "Yatsuhashi boxes (gifts)", where: "Ninenzaka shops", price: "ÃÂÃÂÃÂÃ¥800ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500/box", notes: "Best Kyoto souvenir and very popular gift for Pune. Buy the original cinnamon AND the matcha version." },
        { name: "Kyoto ceramics", where: "Ninenzaka/Sannenzaka boutiques", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3,000", notes: "The Higashiyama area has Kyoto's best pottery shops. Hand-decorated small plates are ÃÂÃÂÃÂÃ¥800 and beautiful." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 11 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ NARA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      startLocation: "Kyoto Station Kyoto",
      activities: [
        { name: "JR to Nara", time: "08:30", cost: "ÃÂÃÂÃÂÃ¥1,140 return adult / ÃÂÃÂÃÂÃ¥570 child",
          notes: "JR Nara Line: Kyoto ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Nara (50 min). JR Pass covers this. Buy deer cracker crackers (shika senbei ÃÂÃÂÃÂÃ¥200) just OUTSIDE the park from official vendors in paper bags ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not inside the park.",
          location: "Nara Station Nara", ticket: "JR Pass / Suica ÃÂÃÂÃÂÃ· JR Nara Line (50 min, ÃÂÃÂÃÂÃ¥710 one way)" },
        ...
        { name: "Todai-ji Temple ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Giant Buddha", time: "10:30", cost: "ÃÂÃÂÃÂÃ¥600 adult / ÃÂÃÂÃÂÃ¥300 child (under 15)",
        ...
        { name: "Kasuga Taisha Shrine", time: "12:30", cost: "Free grounds / ÃÂÃÂÃÂÃ¥500 inner shrine",
      ...
      food: [
        { name: "Shojin ryori / Buddhist veg lunch", where: "Edosan Restaurant near Todaiji", price: "ÃÂÃÂÃÂÃ¥1,500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,500", notes: "Nara's oldest restaurant serves traditional Buddhist vegetarian sets. Tofu, mountain vegetables, rice, miso." },
        { name: "Nara matcha warabi mochi", where: "Naramachi cafÃÂÃÂÃÂÃÂ©s", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ800", notes: "Jelly-like mochi in matcha flavour, dusted with kinako powder. Light and delicious." },
        { name: "Mitarashi dango", where: "Stalls near Kasuga Taisha", price: "ÃÂÃÂÃÂÃ¥150ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ300", notes: "Sweet sticky rice dumplings on a skewer with sweet soy glaze. Vegetarian. Perfect snack." }
      ],
      shopping: [
        { name: "Shika (deer) themed goods", where: "Naramachi shops", price: "ÃÂÃÂÃÂÃ¥300ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500", notes: "Deer are Nara's symbol ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ themed cards, ceramics, keychains. Light and perfect as gifts." },
        { name: "Nara ink sticks and brushes", where: "Traditional shops in Naramachi", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,000", notes: "Nara has a 1,300-year tradition of making Indian ink ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ beautiful craft items." }
      ],
      ...
      hacks: ["ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° JR Pass covers the KyotoÃÂÃÂ¢ÃÂÃÂÃÂÃÂNara round trip ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ free if you have it!", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Deer crackers: buy OUTSIDE the park from vendors in paper bags ÃÂÃÂÃÂÃ¥200 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ cheaper and same product.", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ The pillar hole at Todaiji: kids queue to crawl through ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ arrive early for shorter wait."]
    },
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 12 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ PHILOSOPHER'S PATH + KIMONO ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      startLocation: "Kyoto Station Kyoto",
      activities: [
        { name: "Ginkakuji ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Silver Pavilion", time: "08:30", cost: "ÃÂÃÂÃÂÃ¥500 adult / ÃÂÃÂÃÂÃ¥300 child",
          ...
          ticket: "Suica ÃÂÃÂÃÂÃ· Bus #5 from Kyoto Stn ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Ginkakuji-michi (ÃÂÃÂÃÂÃ¥230)" },
        ...
        { name: "Nanzenji Temple", time: "11:00", cost: "Free (grounds) / ÃÂÃÂÃÂÃ¥600 hojo garden",
          notes: "Massive sanmon gate (ÃÂÃÂÃÂÃ¥600 climb for views). The stone aqueduct bisecting the temple complex is stunning ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ a Victorian-era red-brick structure built over an ancient Buddhist complex. Very photogenic.",
          location: "Nanzenji Temple Sakyo Kyoto", ticket: "Walk from Philosopher's Path end" },
        { name: "Kimono Rental in Gion (4 hrs)", time: "14:00ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ18:00", cost: "~ÃÂÃÂÃÂÃ¥14,000 family of 4 (incl. hair styling)",
          ...
          ticket: "Suica ÃÂÃÂÃÂÃ· Bus #100 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Gion bus stop (ÃÂÃÂÃÂÃ¥230)" },
      ...
      food: [
        { name: "Tofu kaiseki set lunch", where: "Restaurants along Philosopher's Path", price: "ÃÂÃÂÃÂÃ¥1,500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3,000", notes: "Many restaurants on the Path serve beautiful tofu-based vegetarian set lunches. Tousuiro near Nanzenji has a dedicated vegan set." },
        { name: "Matcha parfait", where: "CafÃÂÃÂÃÂÃÂ© Kissa Sawarabi near Ginkakuji", price: "ÃÂÃÂÃÂÃ¥900", notes: "Layers of matcha jelly, bean paste, rice cake, ice cream in a parfait glass. Peak Kyoto experience." }
      ],
      shopping: [
        { name: "Kimono accessories", where: "Rental shop exit / Gion shops", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,000", notes: "Hair pins, folded fans, small pouches in kimono-print fabric. Great for girls." },
        { name: "Wagashi sweets box", where: "Shops along Philosopher's Path", price: "ÃÂÃÂÃÂÃ¥1,000ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,500", notes: "Seasonally crafted traditional sweets ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ beautiful handmade creations. Perfect gift boxes available." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 13 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ NIJO CASTLE + NISHIKI ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      startLocation: "Kyoto Station Kyoto",
      activities: [
        { name: "Nijo Castle", time: "09:00", cost: "ÃÂÃÂÃÂÃ¥1,030 adult / ÃÂÃÂÃÂÃ¥350 child",
          ...
          ticket: "Suica ÃÂÃÂÃÂÃ· Subway Tozai Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Nijo-jo-mae Stn (ÃÂÃÂÃÂÃ¥210)" },
        { name: "Kyoto Imperial Palace Park", time: "11:00", cost: "Free",
          ...
          location: "Kyoto Imperial Palace Kamigyo Kyoto", ticket: "Subway Karasuma Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Imadegawa (ÃÂÃÂÃÂÃ¥210)" },
        { name: "Heian Shrine", time: "12:30", cost: "Free grounds / ÃÂÃÂÃÂÃ¥600 garden",
          notes: "One of Japan's largest torii gates (24m high) marks the entrance. Built in 1895, relatively young for Kyoto. The garden (ÃÂÃÂÃÂÃ¥600) has a stunning pond with stepping stones and a covered bridge ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ beautiful in late May.",
          location: "Heian Shrine Okazaki Kyoto",
          ticket: "Suica ÃÂÃÂÃÂÃ· Bus ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Okazaki-koen (ÃÂÃÂÃÂÃ¥230)" },
        { name: "Nishiki Market", time: "15:00", cost: "Free + snacks ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,000",
          notes: "Kyoto's Kitchen ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 5 blocks of 100+ stalls. Must-tries: fresh yudofu (warm tofu set) ÃÂÃÂÃÂÃ¥500, pickled vegetables ÃÂÃÂÃÂÃ¥300ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ800, tamagoyaki (egg roll) ÃÂÃÂÃÂÃ¥200, mochi ÃÂÃÂÃÂÃ¥150, matcha drinks. All the vendors speak tourist-friendly Japanese. Watch your elbows on weekends.",
          location: "Nishiki Market Nakagyo Kyoto",
          ticket: "Suica ÃÂÃÂÃÂÃ· Subway or walk from Kawaramachi" },
      ...
      food: [
        { name: "Nishiki Market snack crawl", where: "Nishiki Market", price: "ÃÂÃÂÃÂÃ¥150ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ500 per item", notes: "Dashi tamago ÃÂÃÂÃÂÃ¥200 (skip ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ has egg), try: warabi mochi ÃÂÃÂÃÂÃ¥300, Kyoto pickles ÃÂÃÂÃÂÃ¥400, mochi with bean paste ÃÂÃÂÃÂÃ¥150, fresh tofu with dipping soy ÃÂÃÂÃÂÃ¥400." },
        { name: "Tofu hot pot (yudofu)", where: "Restaurants near Nijo area", price: "ÃÂÃÂÃÂÃ¥1,500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,000 set", notes: "Classic Kyoto dish ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tofu gently simmered in kombu broth, served with small sides. Deeply comforting." }
      ],
      shopping: [
        { name: "Kyoto pickles (tsukemono)", where: "Nishiki Market stalls", price: "ÃÂÃÂÃÂÃ¥300ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ800/packet", notes: "Best gift from Kyoto ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ beautifully packaged, lightweight, unique. Try: Shibazuke (purple), Kabu (turnip), Nasu (eggplant)." },
        { name: "Kyo-yasai (Kyoto vegetables) miso", where: "Nishiki Market", price: "ÃÂÃÂÃÂÃ¥600ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500", notes: "Kyoto special misos and sauces ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ delicious vegetarian cooking ingredients to bring back." }
      ],
      ...
      hacks: ["ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Nishiki Market is free to walk ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ only pay for what you taste. Budget ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ800 for a full snack crawl.", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Nijo Castle: let kids try to walk silently on the nightingale floors ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ impossible! They squeak from every angle.", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Kyoto city day bus pass ÃÂÃÂÃÂÃ¥700 covers all buses ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ worth it for a day with multiple stops."]
    },
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 14 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ UJI ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ OSAKA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      startLocation: "Kyoto Station Kyoto",
      activities: [
        { name: "Byodoin Phoenix Hall, Uji", time: "09:00", cost: "ÃÂÃÂÃÂÃ¥600 adult / ÃÂÃÂÃÂÃ¥300 child",
          notes: "The temple on the ÃÂÃÂÃÂÃ¥10 coin! UNESCO World Heritage. Built 1053 AD. The Phoenix Hall is perfectly reflected in the pond ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ one of Japan's most beautiful buildings. Inner hall tour (extra ÃÂÃÂÃÂÃ¥300) shows the original gilded Amida Buddha.",
          location: "Byodoin Temple Uji Kyoto", officialUrl: "https://www.byodoin.or.jp/en/",
          ticket: "JR Pass / Suica ÃÂÃÂÃÂÃ· JR Nara Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Uji Stn (ÃÂÃÂÃÂÃ¥460 from Kyoto, 18 min)" },
        { name: "Mimurotoji Temple ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ HYDRANGEAS ÃÂÃÂ¢ÃÂÃÂ­ÃÂÃÂ", time: "10:30", cost: "ÃÂÃÂÃÂÃ¥500/person",
        ...
        { name: "Matcha Lunch + Soft Serve", time: "12:00", cost: "ÃÂÃÂÃÂÃ¥300ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500",
        ...
        { name: "Travel to Osaka + Check in", time: "15:00", cost: "ÃÂÃÂÃÂÃ¥570/person",
          ...
          location: "Namba Station Osaka", ticket: "JR Pass / Suica ÃÂÃÂÃÂÃ· Uji ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Kyoto ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Osaka (JR Kyoto Line, ÃÂÃÂÃÂÃ¥570 total)" },
      ...
      food: [
        { name: "Matcha soba (cold)", where: "Nakamura Tokichi or Tsuen, Uji", price: "ÃÂÃÂÃÂÃ¥1,200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500", notes: "Cold soba noodles in matcha-infused broth with veg toppings. Unique to Uji. Intensely green." },
        { name: "Matcha soft serve (double cone)", where: "Every shop in Uji", price: "ÃÂÃÂÃÂÃ¥350ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ500", notes: "Get the double ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ matcha + vanilla or matcha + hojicha. The matcha here is stronger than Tokyo versions." },
        { name: "Dotonbori veg okonomiyaki", where: "Mizuno Restaurant, Dotonbori", price: "ÃÂÃÂÃÂÃ¥1,200", notes: "Osaka-style savory pancake with cheese + veg filling. Ask for ÃÂÃÂ¨ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂªÃÂÃÂ£ÃÂÃÂÃÂÃÂ (niku nashi = no meat)." }
      ],
      shopping: [
        { name: "Premium matcha + tea sets", where: "Nakamura Tokichi Uji", price: "ÃÂÃÂÃÂÃ¥800ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3,000", notes: "Best quality matcha to bring home for Pune. Beautiful gift packaging available." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 15 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ USJ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        { name: "Universal Studios Japan ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Full Day", time: "08:30ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ21:00", cost: "ÃÂÃÂÃÂÃ¥8,600 adult / ÃÂÃÂÃÂÃ¥5,600 child",
          notes: "Super Nintendo World first (open at 8am, shorter morning queue). Mario Kart: Bowser's Challenge ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ incredible motion-tracking ride! Power-up band ÃÂÃÂÃÂÃ¥3,500 lets you collect coins physically. Harry Potter Wizarding World: Butterbeer is vegetarian! Minions Park. Sing on Street live show (free). June weekday = shorter queues, no Express Pass likely needed. Get Nintendo World timed entry via the USJ app when you enter.",
          location: "Universal Studios Japan Osaka", officialUrl: "https://www.usj.co.jp/web/en/us",
          ticket: "Suica ÃÂÃÂÃÂÃ· JR Yumesaki Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Universal City Stn (ÃÂÃÂÃÂÃ¥180 from Namba area)" }
      ],
      food: [
        { name: "Butterbeer (HP World)", where: "Three Broomsticks, Wizarding World", price: "ÃÂÃÂÃÂÃ¥790", notes: "Non-alcoholic butterscotch cream drink. Completely vegetarian. Hot or frozen. Kids go crazy for it." },
        { name: "Nintendo mushroom popcorn", where: "Super Nintendo World popcorn stand", price: "ÃÂÃÂÃÂÃ¥500", notes: "Mushroom-shaped popcorn bucket with caramel or cheese popcorn. Vegetarian! Great souvenir too." },
        { name: "Minion banana crepes", where: "Minion Park", price: "ÃÂÃÂÃÂÃ¥600", notes: "Banana-flavoured crepes with Minion-themed packaging. Vegetarian and delicious." }
      ],
      shopping: [
        { name: "Nintendo Power-up Band", where: "Super Nintendo World shop", price: "ÃÂÃÂÃÂÃ¥3,500", notes: "Interactive wristband that lets you collect coins throughout Mario land ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ KIDS LOVE IT. Buy at opening." },
        { name: "HP wands (replica)", where: "Olivanders, Wizarding World", price: "ÃÂÃÂÃÂÃ¥6,000ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ7,000", notes: "Ollivanders experience + own wand. Each wand has a spell location in the HP area." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 16 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ CASTLE + AQUARIUM ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      startLocation: "Namba Station Osaka",
      activities: [
        { name: "Osaka Castle Park", time: "09:00", cost: "Free park / ÃÂÃÂÃÂÃ¥600 museum (under-15 FREE)",
          ...
          ticket: "Suica ÃÂÃÂÃÂÃ· Subway Tanimachi or Chuo Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Osakajo-koen Stn (ÃÂÃÂÃÂÃ¥200)" },
        { name: "Kaiyukan Aquarium", time: "13:00", cost: "ÃÂÃÂÃÂÃ¥2,400 adult / ÃÂÃÂÃÂÃ¥1,200 child",
          ...
          ticket: "Suica ÃÂÃÂÃÂÃ· Subway Chuo Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Osaka-ko Stn (ÃÂÃÂÃÂÃ¥230 from castle)" },
        { name: "Tempozan Ferris Wheel", time: "15:30", cost: "ÃÂÃÂÃÂÃ¥800 adult / ÃÂÃÂÃÂÃ¥400 child",
        ...
        { name: "Indian Dinner at Apt Kitchen", time: "Evening", cost: "Groceries ÃÂÃÂÃÂÃ¥1,500",
          ...
          location: "Namba Station Osaka", ticket: "Suica ÃÂÃÂÃÂÃ· Subway back to Namba" }
      ],
      food: [
        { name: "Veg ekiben at castle park", where: "Pack from konbini before leaving", price: "ÃÂÃÂÃÂÃ¥600ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ900", notes: "Pick up a bento from 7-Eleven before heading to castle ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ much cheaper than castle-area restaurants." },
        { name: "Kaiyukan cafÃÂÃÂÃÂÃÂ© veg options", where: "Inside Kaiyukan", price: "ÃÂÃÂÃÂÃ¥800ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,200", notes: "Vegetable curry and udon available. Ask counter staff for 'ÃÂÃÂ¨ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂªÃÂÃÂ£ÃÂÃÂÃÂÃÂ' (no meat)." }
      ],
      shopping: [
        { name: "Aquarium themed goods", where: "Kaiyukan gift shop", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,000", notes: "Whale shark stuffed toys are a Kaiyukan exclusive ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ only sold here. Kids love them." }
      ],
      ...
      hacks: ["ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Buy Kaiyukan tickets at konbini kiosks (7-Eleven, FamilyMart) to skip the entry queue entirely.", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Kids under 15 are FREE at Osaka Castle museum ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ save ÃÂÃÂÃÂÃ¥600+ per child!", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Transparent gondola on Tempozan: arrive 15 min early and request it ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ stunning views straight down."]
    },
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 17 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ POKEMON CAFE + SHINSEKAI ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      startLocation: "Namba Station Osaka",
      activities: [
        { name: "ÃÂÃÂ¢ÃÂÃÂ­ÃÂÃÂ PokÃÂÃÂÃÂÃÂ©mon Cafe Osaka (PRE-BOOKED)", time: "Booked slot (11:00 or 12:00)", cost: "~ÃÂÃÂÃÂÃ¥3,000/person",
        ...
        { name: "Den Den Town (Osaka's Akihabara)", time: "14:00", cost: "Free",
          ...
          ticket: "Suica ÃÂÃÂÃÂÃ· Subway Sakaisuji Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Ebisucho Stn (ÃÂÃÂÃÂÃ¥200)" },
        { name: "Shinsekai Retro District", time: "16:00", cost: "Free",
          notes: "Osaka's old entertainment district from the 1920s. Neon signs, retro arcades, old-school restaurants. Tsutenkaku Tower ÃÂÃÂÃÂÃ¥1,000 (kids love the quirky Billiken luck statue at the top). America-Mura street art nearby.",
          location: "Shinsekai Osaka",
          ticket: "Walk 10 min from Den Den Town" },
        { name: "Kuromon Ichiba Market", time: "17:30", cost: "Free to browse",
          notes: "Osaka's famous covered food market. Closes 6pm ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ go before then. Fresh tofu, veg tempura, Kyoto pickles, tofu donuts. Stock up the apt kitchen. Also try: grilled corn ÃÂÃÂÃÂÃ¥300.",
          location: "Kuromon Ichiba Market Osaka",
          ticket: "Suica ÃÂÃÂÃÂÃ· Walk from Shinsekai or Subway Sakaisuji Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Nipponbashi" }
      ],
      food: [
        { name: "PokÃÂÃÂÃÂÃÂ©mon Cafe character pancakes", where: "PokÃÂÃÂÃÂÃÂ©mon Cafe Osaka", price: "ÃÂÃÂÃÂÃ¥1,200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,800", notes: "Pikachu pancakes, themed omelette sets. Ask staff for vegetarian option ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ egg-based but no meat." },
        { name: "Veg kushikatsu", where: "Shinsekai area restaurants", price: "ÃÂÃÂÃÂÃ¥100ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ200/skewer", notes: "Deep-fried breaded vegetables on skewers: potato, pumpkin, lotus root, onion. Ask for veg only (ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ®ÃÂÃÂ£ÃÂÃÂÃÂÃÂ¿). The strict rule: never double-dip the sauce!" },
        { name: "Kuromon tofu donuts", where: "Kuromon Ichiba Market", price: "ÃÂÃÂÃÂÃ¥100ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ150 each", notes: "Freshly fried tofu donuts in various flavours. Hot and crispy. Completely vegetarian." }
      ],
      shopping: [
        { name: "PokÃÂÃÂÃÂÃÂ©mon Cafe exclusive merch", where: "PokÃÂÃÂÃÂÃÂ©mon Cafe shop", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3,000", notes: "Cafe-exclusive plushies and items only available at the cafÃÂÃÂÃÂÃÂ©. Buy at the end of your meal." },
        { name: "Tsutenkaku omiyage", where: "Tsutenkaku Tower souvenir shop", price: "ÃÂÃÂÃÂÃ¥300ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ800", notes: "Billiken (Osaka's lucky god) themed goods are unique to Shinsekai and not found elsewhere." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 18 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ SHOPPING ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        { name: "Sumiyoshi Taisha Shrine", time: "09:00", cost: "Free",
          ...
          ticket: "Suica ÃÂÃÂÃÂÃ· Nankai Honsen Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Sumiyoshi-taisha Stn (ÃÂÃÂÃÂÃ¥250 from Namba)" },
        { name: "Shinsaibashi Shopping Arcade", time: "11:30", cost: "Tax-free on ÃÂÃÂÃÂÃ¥5,000+",
          notes: "580m covered arcade ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Osaka's main shopping street. Fashion boutiques, Kiddyland (for kids' toys), Uniqlo, cosmetics. Show passport at department stores for 10% tax-free refund on ÃÂÃÂÃÂÃ¥5,000+ per transaction. Good for: Japanese skincare, Uniqlo basics, unique snacks.",
          location: "Shinsaibashi Shopping Arcade Osaka",
          ticket: "Suica ÃÂÃÂÃÂÃ· Subway Midosuji Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Shinsaibashi Stn (ÃÂÃÂÃÂÃ¥350)" },
        ...
        { name: "Dotonbori Farewell Walk", time: "Evening", cost: "Free",
          notes: "Final evening stroll under the neon lights. Take all the photos you missed on Day 1. The canal boat ride (ÃÂÃÂÃÂÃ¥900 adult) gives a unique low-angle view of all the neon signs.",
        ...
        { name: "Depachika Basement Food Hunt", time: "After 19:00", cost: "Half-price deals!",
          notes: "Department store food basements (Takashimaya B2F, Daimaru B1F). After 7pm: look for orange ÃÂÃÂÃÂÃÂ½ÃÂÃÂ¤ÃÂÃÂ¾ÃÂÃÂ¡ (han-ka = half price) stickers on premium wagashi, bento, French pastries. Premium sweets for ÃÂÃÂÃÂÃ¥200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ400. Truly excellent late-night hack.",
          location: "Takashimaya Department Store Namba Osaka",
          ticket: "Walk from Dotonbori (5 min)" }
      ],
      food: [
        { name: "Veg tempura set lunch", where: "Restaurants near Shinsaibashi", price: "ÃÂÃÂÃÂÃ¥1,200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,800", notes: "Vegetable tempura teishoku: seasonal veg, rice, miso, pickles. Light and satisfying." },
        { name: "Depachika wagashi (after 7pm)", where: "Takashimaya or Daimaru basement", price: "ÃÂÃÂÃÂÃ¥200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ400 after discount", notes: "Wait for the ÃÂÃÂÃÂÃÂ½ÃÂÃÂ¤ÃÂÃÂ¾ÃÂÃÂ¡ stickers ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ premium sweets like Yatsuhashi, wagashi sets, ÃÂÃÂÃÂÃÂ©clair at half price." }
      ],
      shopping: [
        { name: "Souvenirs for Pune", where: "Don Quijote / Shinsaibashi", price: "ÃÂÃÂÃÂÃ¥200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ500/item", notes: "Matcha Kit Kat, Tokyo Banana, Royce chocolate, wasabi peas, pocky sets ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ great for gifts, well-priced." },
        { name: "Uniqlo Heattech / LifeWear", where: "Uniqlo Shinsaibashi", price: "ÃÂÃÂÃÂÃ¥990ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,990", notes: "Tax-free applies on ÃÂÃÂÃÂÃ¥5,000+ spend. Japanese Uniqlo has first-run items not yet in India." }
      ],
      ...
      hacks: ["ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Tax-free at Shinsaibashi: show passport, min ÃÂÃÂÃÂÃ¥5,000 spend per store = 10% back instantly.", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Depachika after 7pm = best food deals in Osaka. Keep ÃÂÃÂÃÂÃ¥2,000 cash for this.", "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Canal boat in Dotonbori: ÃÂÃÂÃÂÃ¥900 for 20 min ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ worth it for the unique low-angle neon photos."]
    },
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 19 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ UMEDA SKY + FINAL OSAKA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      startLocation: "Namba Station Osaka",
      activities: [
        { name: "Umeda Sky Building Floating Garden", time: "09:00 (or at sunset)", cost: "ÃÂÃÂÃÂÃ¥1,500 adult / ÃÂÃÂÃÂÃ¥700 child",
          ...
          ticket: "Suica ÃÂÃÂÃÂÃ· JR Osaka Loop Line or Subway ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Umeda/Osaka Stn (ÃÂÃÂÃÂÃ¥200 from Namba)" },
        { name: "Tenjinbashisuji Covered Arcade", time: "11:00", cost: "Free",
          ...
          ticket: "Subway Tanimachi Line ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Tenjimbashisuji 6-chome (ÃÂÃÂÃÂÃ¥200)" },
        { name: "Final Konbini Snack Haul", time: "Afternoon", cost: "ÃÂÃÂÃÂÃ¥3,000ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5,000",
      ...
      food: [
        { name: "Takimi-koji underground market", where: "Umeda Sky Building basement", price: "ÃÂÃÂÃÂÃ¥800ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500", notes: "Atmospheric 1920s market design in the basement. Several veg-friendly options including tofu hot pot and veg curry." }
      ],
      shopping: [
        { name: "Royce Chocolate (buy from store only)", where: "7-Eleven or airport", price: "ÃÂÃÂÃÂÃ¥1,500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3,000/box", notes: "Keep refrigerated ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ get a cold pouch from the store. The nama chocolate is famous and best as a gift." },
        { name: "Vacuum-packed matcha goods", where: "Any konbini", price: "ÃÂÃÂÃÂÃ¥300ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ800/pack", notes: "Matcha Kit Kats, Matcha Oreos, Maccha Yan Yan ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ best airline-friendly gifts." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 20 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ OSAKA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ HANEDA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      activities: [
        { name: "Check out Osaka Hotel", time: "By 11:00", cost: "",
          ...
          location: "Shin-Osaka Station Osaka", ticket: "Suica ÃÂÃÂÃÂÃ· Subway to Shin-Osaka" },
        { name: "Shin-Osaka ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Shinagawa (Shinkansen Hikari)", time: "~11:30", cost: "JR Pass covers Hikari (ÃÂÃÂÃÂÃ¥6,740 adult / ÃÂÃÂÃÂÃ¥3,370 child without)",
        ...
        { name: "Shinagawa ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Haneda Terminal 2 (Keikyu)", time: "~14:00", cost: "ÃÂÃÂÃÂÃ¥470/person",
          notes: "Keikyu Airport Line from Shinagawa: 14 min, very frequent. Easy with luggage.",
          location: "Haneda Airport Terminal 2 Tokyo", ticket: "Suica ÃÂÃÂÃÂÃ· Keikyu Airport Express (ÃÂÃÂÃÂÃ¥470)" },
        ...
        { name: "HND Duty-Free Shopping", time: "Evening", cost: "Budget ÃÂÃÂÃÂÃ¥5,000ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ10,000",
      ...
      food: [
        { name: "Shinkansen ekiben", where: "Shin-Osaka platform shops", price: "ÃÂÃÂÃÂÃ¥1,200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,800", notes: "Buy a bento at the platform before boarding. Veg options: vegetable rice box, tofu box sets." }
      ],
      shopping: [
        { name: "Japanese whisky / sake", where: "HND duty free", price: "ÃÂÃÂÃÂÃ¥3,000ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ8,000", notes: "Yamazaki, Hibiki, Nikka at better prices than India. Popular gift." },
        { name: "Last matcha goods", where: "HND duty free", price: "ÃÂÃÂÃÂÃ¥500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2,000", notes: "Airport has good selection of matcha Kit Kat, Pocky, and branded confectionery boxes." }
      ],
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DAY 21 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FLY HOME ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    {
      ...
      food: [
        { name: "HND T2 Airport food", where: "Terminal 2 F&B before security", price: "ÃÂÃÂÃÂÃ¥800ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1,500", notes: "Last Japanese meal! Try a proper bowl of ramen or katsu curry before boarding." }
      ],
      shopping: [
